...
| <a name="input_rune_version"></a> [rune\_version](#input\_rune\_version) | Rune release tag passed to install-server.sh (e.g. 'v0.0.1-dev.22'). Pinned by default for reproducibility; bump per module release. | `string` | `"v0.0.1-dev.22"` | no |
